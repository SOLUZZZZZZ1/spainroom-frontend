...
export default function Inquilinos(){
  ...
  // Carga dinámica y tolerante de Jobs.jsx (no rompe si no existe)
  useEffect(()=>{
    let mounted = true
    import('./Jobs.jsx')
      .then(mod => { if(mounted) setJobsComp(()=>mod.default) })
      .catch(()=> { /* no pasa nada, dejamos un placeholder */ })
  ...
  return (
    <div className="container" style={{padding:'24px 0'}}>
      ...
      <p className="note">Recursos y oportunidades para inquilinos. Aquí tienes ayuda directa y, debajo, empleo cerca de ti.</p>
        ...
        {JobsComp
          ...
          : (
            <div style={{background:'#fff',border:'1px solid #e2e8f0',borderRadius:12,padding:16}}>
              {jobsReady
                ? <span className="note">Añadiremos aquí el buscador de empleo. De momento, pregunta a Nora y te orienta. 😊</span>
