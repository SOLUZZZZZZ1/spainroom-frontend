...
export default function Propietarios(){
  ...
  const ExplicacionMapa = () => (
    <div style={{background:'#fff', border:'1px solid #e2e8f0', borderRadius:16, padding:16}}>
      ...
      <ul style={{margin:'10px 0 0 18px', color:'#0b1220'}}>
        ...
        <li><strong>Depende</strong> (ámbar): varía por municipio, antigüedad o uso; consulta siempre el Ayuntamiento.</li>
        <li><strong>No obligatorio</strong> (verde): no se exige en general; guarda justificantes (altas, IBI, CEE).</li>
      </ul>
      <details style={{marginTop:10}}>
        <summary style={{cursor:'pointer', fontWeight:800}}>Seguridad mínima recomendada</summary>
        <div style={{marginTop:8, color:'#475569'}}>
          <ul style={{margin:'0 0 0 18px'}}>
            <li>Detector de humo, extintor y manta ignífuga en cocina.</li>
            <li>Plan de evacuación simple + luces de emergencia/linterna.</li>
            <li>Cerradura antibumping; llave interior en dormitorios.</li>
            <li>Diferencial y magnetotérmicos testados; boletines tras reforma.</li>
            <li>Botiquín y 112 visible.</li>
          </ul>
        </div>
      </details>
      <div className="note" style={{marginTop:10}}>
        *Orientativo. La interpretación final corresponde a tu Ayuntamiento o CCAA.
      </div>
    </div>
  )
  ...
  return (
    <div className="container" style={{padding:'24px 0', color:'#0b1220'}}>
      ...
      {/* Banner de ayuda en gestión */}
      <div style={{margin:'0 0 16px'}}>
        <NoraHelp
          title="¿No tienes la cédula o documentación? SpainRoom te ayuda en los trámites"
          bullets={[
            'Requisitos por municipio y comunidad',
            'Preparación de documentación y cita',
